...
const config = {
    apiKey: "AIzaSyCG2EmESCf1Xzi2HoSIMDu1lbA3T5Uf3-4",
      authDomain: "bvv-426905.firebaseapp.com",
      databaseURL: "https://bvv-426905-default-rtdb.firebaseio.com",
      projectId: "bvv-426905",
      storageBucket: "bvv-426905.appspot.com",
      messagingSenderId: "212452479587",
      appId: "1:212452479587:web:7365866d6bd57886e25e56",
      measurementId: "G-BK6CQYVZQH"
 }
 ...
 const paginate = async() => {
     ...
     docs["docs"].forEach((doc, i) => {
         ...
         anchor.setAttribute("href", "article.html#/" + doc.id);
 ...
 const createChild = (postData) =>{
     if(singlePost !== null){
         ...
         let linkNode = document.createTextNode("Read More");
 ...
 const createChildren = async(arr) => {
     if(posts != null){
         arr.map( post => {
             ...
             anchor.setAttribute("href", "article.html#/" + post.id);
 ...
 const appendEditForm = async() => {
     ...
     linkInput.setAttribute("value", currentLink); 
     linkInput.setAttribute("id", "editLink");
     ...
     document.getElementById("editLink").value = currentLink;
 ...
 document.addEventListener("DOMContentLoaded", (e) => {
     getPosts();
     if(!location.href.includes("post.html") && !location.href.includes("addpost.html") ){
         getPost();
     }
